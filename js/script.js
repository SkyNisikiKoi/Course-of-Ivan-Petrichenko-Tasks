...
//1. расчитать общую площадь для каждого магазина
//2. посчитать общаю площадь
...
function isBudgetEnough(data) {
    ...
    let dataArr = Object.entries(data.shops);
    let totalArea = 0;
    ...
    dataArr.forEach(item => {
        ...
        object.forEach(item => {
            ...
            totalArea = totalArea + (item.width * item.length);
            console.log(width);
            console.log(length);
            });
